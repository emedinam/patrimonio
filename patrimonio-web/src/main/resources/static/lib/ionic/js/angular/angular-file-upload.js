...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function (fileUploaderOptions, $rootScope, $http, $window, FileLikeObject, FileItem, Fotos) {
	        ...
	        _createClass(FileUploader, {
	            ...
	            removeFromQueue: {
	                ...
	                value: function removeFromQueue(value) {
	                    ...
	                    Fotos.delete({idFicha: item.idFicha ,idFoto: item.id});  ///DELETE TORO
	                    item._destroy();
	                    this.progress = this._getTotalProgress();
	                }
	            },
	...
	module.exports.$inject = ["fileUploaderOptions", "$rootScope", "$http", "$window", "FileLikeObject", "FileItem","Fotos"];
